...
import RipoList from '../Components/Repos/RepoList';

function User() {
  const { user, repos, getUser, getUserRepos, loading } = useContext(GithubContext);
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                ...
                {hireable && (
                  <div className="mx-1 badge badge-info">Hiarable</div>
                )}
              </h1>
              <p>{bio}</p>
